...
public final class AgentOptions {
  ...
  /**
   * Specifies directory where class bytecode files will be generated. This is useful
   * for Gosu classes.
   */
  ...
  /**
   * Gets the directory where we want to safe class files for which bytecode is
   * dynamically generated. NULL if not specified, no class files will be safed.
   *
   * @return directory where we will put dump files
   */
