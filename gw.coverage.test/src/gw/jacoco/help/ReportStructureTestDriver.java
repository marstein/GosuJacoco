 ...
 * {@link org.jacoco.report.IReportVisitor} instances.
 */
public class ReportStructureTestDriver {
  ...
  public ReportStructureTestDriver() {
    ...
    m.increment(CounterImpl.getInstance(3, 5), CounterImpl.getInstance(1, 2), 2);
    ...
    final SourceFileCoverageImpl sourceFileCoverageImpl = new SourceFileCoverageImpl("FooClass.java", "org/jacoco/example");
