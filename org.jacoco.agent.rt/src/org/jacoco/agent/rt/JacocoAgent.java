...
public class JacocoAgent {
  ...
  public void init(final Instrumentation inst) throws Exception {
    ...
    // Gosu
//    gw.lang.parser.InstrumentationManager.addBytecodeTransformer(new JacocoGosuBytecodeTransformer(runtime, options, logger));
//    inst.addTransformer(new JacocoGosuCoverageTransformer(runtime, options, logger));
   ...
   *             creation problem
   */
  protected IRuntime createRuntime(final Instrumentation inst) throws Exception {
